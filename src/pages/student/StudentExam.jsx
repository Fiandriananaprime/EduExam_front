...
const StudentExamPage = () => {
  ...
  const submitCurrentExam = async () => {
    try {
      ...
      showToast(
        err.message || 'Failed to submit exam.',
        'error'
      );
    ...
    return (
      <div className="min-h-screen bg-cream flex items-center justify-center">
        <div className="text-center">
          <div className="font-serif text-4xl text-taupe mb-2">
            ∅
          </div>
        ...
        <div className="flex items-center gap-4 min-w-0">
          ...
          <div className="min-w-0">
            ...
            <div className="font-mono text-xs text-taupe">
              {exam.courseName || exam.course?.name}
            </div>
          </div>
        </div>
          ...
          <div className="px-6 py-8 max-w-3xl mx-auto w-full space-y-12">
            ...
            <div className="pt-8 border-t border-rule flex justify-center pb-12">
              <button
                onClick={() => setShowSubmitModal(true)}
                disabled={submitting}
                className="px-8 py-3 bg-sage text-cream rounded-xl text-base font-medium hover:bg-sage/90 transition-colors shadow-lg disabled:opacity-50"
              >
                Submit Exam
              </button>
            </div>
